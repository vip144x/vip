...
if(!file_exists('config.json')){
	$token = readline('HELLO Sdam Enter Token: ');
	$id = readline('HELLO Sdam Enter Id: ');
			...
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/vip188x",
                   'caption'=>'تمت البرمجه بواسطه (@vip188x) ',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل حساب وهمي في البوت 🏃‍♂','callback_data'=>'login']],
                       [['text'=>"قناة نشر صيد المشتركين 🔥", 'url'=>"https://t.me/QQQQQ9Q"]],
                      ]
                  ])
              ]);   
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'⏸ بدء الصيد','callback_data'=>'run'],['text'=>'▶️ ايقاف الصيد','callback_data'=>'stop']],
                              ...
                              [['text'=>' مطور البوت','url'=>'t.me/vip188x'],['text'=>' قناتي ','url'=>'t.me/QQQQQ9Q']],
                      ]
                  ])
                  ]);
          		    $config['mode'] = null;
...
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| MHR','url'=>'t.me/@vip188x']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/QQQQQ9Q"]],
                      ]
                  ])
              ]);   
				}
